 ...
 * queue for a human to review, not production data. The array itself lives
...
export interface CandidateItem {
  ...
  stars: number;
  topics: string[];
  /** "known-org" = from an org listed in scripts/trusted-orgs.mjs; "topic-search" = matched a GitHub topic like `claude-code-hook`. */
...
export const candidateItems: CandidateItem[] = rawCandidates as CandidateItem[];
